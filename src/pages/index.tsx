  ...
  return (
    <>
      ...
      <div className="flex h-screen justify-center bg-gray-700">
        <div className="mt-16 flex flex-col gap-2 rounded-lg bg-gray-800 w-80 p-4 text-gray-100">
          ...
          <div className="flex justify-around">
            <div className="">
              ...
              <h2 className="text-lg">${moneyFlow.reduce((partialSum, a) => partialSum + a.amount, 0)}</h2>
            </div>
            <button
              ...
              <h2 className="text-2xl text-red-700">
                ...
                {Math.abs(
                  moneyFlow
                    ...
                    .reduce((partialSum, a) => a.amount + partialSum, 0)
                )}
              </h2>
            </div>
            <div className="w-full">
